...
class _ExpriceScreenState extends State<ExpriceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: _appBar(),body: _messagesListView(),
    );
  }
  PreferredSizeWidget _appBar(){
    return AppBar(
      ...
      title: const Padding(
        ...
        child: Center(
          child: Text("Expired articles",
            style: TextStyle(color: Colors.blue,fontWeight: FontWeight.bold),
            // textDirection: TextDirection.ltr,
          ),
        ),
      ),
      actions: const [Icon(Icons.wallet,color: Colors.white,)],
    );
  }
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Visibility(
                                  visible: doc['imgPost']!="",
                                  child: Image(image: NetworkImage(doc['imgPost'])),
                                ),
                                Padding(
